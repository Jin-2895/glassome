...
### Step 9. Import new data to **Contentful** 
- Save table with new data as .CSV file and format it to JSON format using this tool [CSV -> JSON](https://csvjson.com/csv2json)
- Use generate.ts(root of the project) script for creating correspondent import.json format, for faster copy-paste and generate [TS playground](https://www.typescriptlang.org/play)
- Format generated object to JSON using [Convert Simple](https://www.convertsimple.com/convert-javascript-to-json/)
- Paste JSON to import.json
- npm run import       
